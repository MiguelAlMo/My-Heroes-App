...
class HeroDTO: Codable {
    ...
    init(response: String?, id: String?, name: String?, powerstats: PowerstatsDTO?, biography: BiographyDTO?, appearance: AppearanceDTO?, work: WorkDTO?, connections: ConnectionsDTO?, image: ImageDTO?) {
...
//
    ...
    init(intelligence: String?, strength: String?, speed: String?, durability: String?, power: String?, combat: String?, statBar: String?) {
